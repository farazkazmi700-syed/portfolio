      ...
      <div className="container-max">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="card-dark p-8 relative overflow-hidden">
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                I'm currently open to <span className="text-primary font-medium">internship opportunities</span> where I can grow, contribute, and apply AI to solve meaningful problems.
              </p>
          ...
          <div className="space-y-6">
            ...
            >
              <h4 className="font-display font-semibold text-white text-sm mb-4">Soft Skills</h4>
