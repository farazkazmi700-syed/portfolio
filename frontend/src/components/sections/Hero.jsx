  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-mesh">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-accent/25 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-primary/10 rounded-full blur-3xl" />
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-accent/15 rounded-full blur-2xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <motion.h1
              ...
              className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-ink leading-tight mt-4 mb-4"
            >
              Hi, I'm{" "}
              <span className="gradient-text">Faraz</span>
              <br />
              <span className="text-3xl sm:text-4xl lg:text-5xl text-ink/70">
                I build{" "}
              </span>
              <span className="text-3xl sm:text-4xl lg:text-5xl text-primary font-body font-semibold">
                AI automation
              </span>
              <span className="text-3xl sm:text-4xl lg:text-5xl text-ink/70">
                {" "}with Python
            ...
            >
              AI & Automation Engineer and Python Developer with a strong passion
              for building practical, real-world systems that eliminate repetitive
              work and make processes smarter. I design and deploy AI chatbots,
              intelligent detection systems, and end-to-end automation pipelines —
              turning manual, time-consuming tasks into efficient, self-running
              solutions. Actively expanding my expertise in Python, Machine
              Learning, Deep Learning, and LLM integration to build applications
              that are practical, scalable, and genuinely useful.
            </motion.p>
            ...
            >
              <a href="#projects" className="btn-primary w-full sm:w-auto flex items-center justify-center gap-2">
                View My Work
                <FiArrowDown />
              </a>
              <a href="#contact" className="btn-outline w-full sm:w-auto flex items-center justify-center gap-2">
                <FiMail size={16} />
                Get In Touch
              </a>
            </motion.div>
            ...
            >
              ...
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="w-10 h-10 rounded-full bg-white border border-dark-border flex items-center justify-center text-muted hover:text-primary hover:border-primary transition-all duration-200 hover:scale-110"
                >
                  <Icon size={18} />
                </a>
              ))}
            ...
            >
              <div className="relative h-[20rem] w-[16rem] md:h-[22rem] md:w-[18rem] lg:h-[26rem] lg:w-[21rem] overflow-hidden rounded-3xl border border-primary/20 bg-dark-card shadow-2xl shadow-primary/10 drop-shadow-2xl animate-pulse-glow">
                ...
                <div className="absolute inset-x-5 bottom-5">
                  <p className="font-display text-2xl md:text-3xl font-extrabold text-ink">
                    Faraz Kazmi
                  </p>
