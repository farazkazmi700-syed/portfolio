      ...
      <div className="container-max relative z-10">
        ...
        >
          ...
          <h2 className="section-title">
            <span className="t-yellow">What I've</span>{" "}
            <span className="t-underline">Built</span>
          </h2>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-mono transition-all duration-200 ${
                active === cat
                  ...
                  : "bg-dark-surface border border-dark-border text-gray-400 hover:text-ink hover:border-primary/40"
              }`}
            >
              {cat}
            </button>
