      ...
      <div className="container-max">
        ...
        >
          ...
          <h2 className="section-title">
            ...
            <span className="t-underline">Background</span>
          </h2>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <motion.h3
              ...
              className="font-display font-bold text-ink drop-shadow-md text-lg mb-6 flex items-center gap-3"
            >
              <span className="w-8 h-8 rounded-lg bg-ink text-accent flex items-center justify-center text-sm"><FiBookOpen size={15} /></span>
              Education
            </motion.h3>
              ...
              {cvData.education.map((edu, i) => (
                ...
                >
                  ...
                  <div className="card-dark p-6 hover:border-primary/30 transition-all duration-300">
                    ...
                    <h4 className="font-display font-bold text-ink text-sm mb-1">{edu.degree}</h4>
          ...
          <div>
            <motion.h3
              ...
              className="font-display font-bold text-ink drop-shadow-md text-lg mb-6 flex items-center gap-3"
            >
              <span className="w-8 h-8 rounded-lg bg-ink text-accent flex items-center justify-center text-sm"><FiAward size={15} /></span>
              Certifications
            </motion.h3>
