...
export default function Contact() {
  ...
  const inputClass =
    "w-full bg-dark-surface border border-dark-border rounded-md px-4 py-3 text-ink placeholder-gray-400 font-body text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-all";
      ...
      <div className="container-max relative z-10">
        ...
        >
          ...
          <h2 className="section-title">
            <span className="t-yellow">Let's</span>{" "}
            <span className="t-underline">Connect</span>
          </h2>
            ...
            {[
              ...
              <div key={label} className="card-dark p-5 flex items-center gap-4 hover:border-primary/30 transition-all group">
                ...
                <div>
                  ...
                  {href ? (
                    <a href={href} className="text-ink hover:text-primary transition-colors text-sm font-body">{value}</a>
                  ) : (
                    <p className="text-ink text-sm font-body">{value}</p>
                  )}
                </div>
              </div>
            ))}
