        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <a href="#hero" className="flex items-center gap-2 group">
              <div className="w-8 h-8 rounded-md bg-ink flex items-center justify-center font-display font-bold text-accent text-sm group-hover:scale-110 transition-transform">
                F
              </div>
              <span className="font-display font-bold text-ink text-lg hidden sm:block tracking-wide">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="md:hidden p-2 rounded-md text-ink hover:text-primary hover:bg-surface transition-all"
              >
            ...
            <div className="px-6 py-4 flex flex-col gap-2">
              {navLinks.map((link) => (
                <a
                  ...
                  className="py-3 px-4 text-ink hover:text-primary hover:bg-surface rounded-md transition-all font-body"
                >
                  {link.label}
                </a>
              ))}
